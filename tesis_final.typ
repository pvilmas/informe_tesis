...
#capitulo(title: "Introducción")[
  ...
  El problema propuesto aborda el estudio de la escalabilidad de estas simulaciones, con el objetivo de proponer una solución que mejore su _performance_ y el uso de recursos computacionales, en especial para escenarios que contemplen una alta carga de tráfico vehicular urbano y de esta manera poder implementar un sistema de simulaciones para dispositivos de memoria compartida tales como supercomputadores, facilitando su uso para el desarrollo de modelos tales como _Gemelos Digitales_. En un estado preliminar de este trabajo, se realiza un estudio de la escalabilidad de simulaciones sin paralelizar, el cual muestra que los tiempos de ejecución de estas simulaciones crecen de una manera exponencial. Adicionalmente, se muestra que el uso de CPU en cada simulación se mantiene constante en un 100%; es decir, cada una de las simulaciones ejecutadas utiliza la totalidad de los recursos asignados, lo cual, en adición al crecimiento de los tiempos de simulación, es inconveniente para la implementación de modelos a gran escala y con alta demanda de tráfico.
...
#capitulo(title: "Problema")[
  ...
  Para este experimento, se implementa una forma automatizada para obtener los datos necesarios desde OpenStreetMap (OSM). Esta automatización toma una localización descrita en coordenadas, y consulta los datos requeridos a través de 30 iteraciones, donde el tamaño de la red es más grande con cada iteración. 
